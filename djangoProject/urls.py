...
urlpatterns = [
    ...
    path("password_change/", views.PasswordChangeView.as_view(form_class=NewPasswordChangeForm), name="password_change"),
...
# document_root=settings.MEDIA_ROOT- reprezinta folderul fizic in care fisierele media sunt stocate
