...
class StudentCreateView(LoginRequiredMixin, PermissionRequiredMixin, SuccessMessageMixin, CreateView):
    ...
    success_url = reverse_lazy('list-of-students')  # dupa salvarea datelor in tabela specificam unde sa fie redirectionat utilizatorul.
    ...
    def form_valid(self, form):
        if form.is_valid():
            ...
            HistoryStudent.objects.create(message=history_text, created_at=datetime.now(),
